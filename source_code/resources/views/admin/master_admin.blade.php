    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route('admin.customer.getList') }}">QUẢN TRỊ WEBSITE</a>
            </div>
            <!-- /.navbar-header -->
            <!-- /.navbar-top-links -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li> 
							...
							<a style = "font-size: 13px;font-weight: bold;color: #574545;" href="{{route('admin.product.getList')}}">
								<img style = "width: 18px; margin-right: 7px;" src = "/uploads/service/20190627065540.png" title = "Sản phẩm"/>
								Sản phẩm   
						   </a>
						   <a style = "font-size: 13px;font-weight: bold;color: #574545;" href="{{route('admin.news.getList')}}">
								<img style = "width: 18px; margin-right: 7px;" src = "/uploads/service/20190627065540.png" title = "Sản phẩm"/>
								Bài viết   
						   </a>
						</li>
