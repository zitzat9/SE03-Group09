            ...
            <div class="carousel slide" data-ride="carousel" id="carousel-1">
                <div class="carousel-inner" role="listbox">
                 <div class="item active"><img class="img-responsive" src="news/img/a.png" alt="Slide Image" style="min-width: 100%; min-height: 90vh;"></div>
                    <div class="item"><img src="news/img/b.png" alt="Slide Image" style = " min-height: 90vh;"></div>
                    <div class="item"><img src="news/img/c.png" alt="Slide Image" style = " min-height: 90vh;"></div>
                </div>
                               ...
                               <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    <div class="blog_post" style="margin-left: 15px">
                                        <img src="{{$lt->news_img}}" style="width:auto;height:auto;">
